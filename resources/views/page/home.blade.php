            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4">
                <div class="card card-hover">
                    <a href="#" class="relative text-gra" x-data x-ripple>
                        <img src="https://raw.githubusercontent.com/ShareCosplay/images-6/main/Makachan%20-%201685665804006%20-%20Azur%20Lane%20-%20Chapayev/cover/d801d9e4d85ecfbe0a1b5a0e1e32802a.jpg" alt="product-1" loading="lazy">
                        <div class="p-4">
